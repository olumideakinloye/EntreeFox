                ...
                if (typeof obj.action != "undefined") {
                    if (obj.action == "delete_order") {
                        ...
                        if (obj.state == "inserted") {
                            document.getElementById(`follow${obj.id}button`).style.backgroundColor = "white";
                            document.getElementById(`follow${obj.id}button`).style.border = "2px solid black";
                            document.getElementById(`follow${obj.id}button`).value = "Following";
                            document.getElementById(`follow${obj.id}button`).style.color = "black";
                            document.getElementById(`follow${obj.id}button`).style.height = "40px";
                        } else if (obj.state == "removed") {
                            document.getElementById(`follow${obj.id}button`).style.backgroundColor = "rgb(255, 172, 124)";
                            document.getElementById(`follow${obj.id}button`).style.border = "none";
                            document.getElementById(`follow${obj.id}button`).value = "Follow back";
                            document.getElementById(`follow${obj.id}button`).style.color = "white";
                            document.getElementById(`follow${obj.id}button`).style.height = "40px";
                        }
                    }
                }
...
<body>
    <header id="header">
        ...
        ?>
        <div class="left">
            <a href="<?php echo $return_to ?>"><img src="<?= ROOT ?>arrow.png"></a>
            <h1>Notification</h1>
        </div>
        <div class="top">
